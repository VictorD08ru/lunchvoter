...
import static tk.djandjiev.lunchvoter.backend.util.ValidationUtil.assureIdConsistent;
import static tk.djandjiev.lunchvoter.backend.util.ValidationUtil.checkNew;
